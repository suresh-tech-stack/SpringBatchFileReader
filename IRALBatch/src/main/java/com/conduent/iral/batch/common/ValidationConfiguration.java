...
public class ValidationConfiguration {
	...
	@Bean
	public ItemProcessor<IRALAckFile, IRALAckFile> validatingItemProcessor(Validator validator) {
		LOGGER.debug("In ValidationConfiguration :: Enter into validatingItemProcessor method {} ");
		SpringValidator<IRALAckFile> springValidator = new SpringValidator<>();
		springValidator.setValidator(validator);
		ValidatingItemProcessor<IRALAckFile> ValidatingItemProcessor = new ValidatingItemProcessor<>();
